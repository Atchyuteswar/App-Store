    ...
    <section className="container py-6">
      <div className="relative overflow-hidden rounded-xl bg-primary text-primary-foreground p-8 md:p-12">
        <div className="relative z-10 max-w-2xl space-y-4">
          ...
          <p className="text-lg opacity-90">{featured.tagline}</p>
          <div className="flex flex-wrap gap-3 pt-2">
            <Button size="lg" variant="secondary" onClick={() => navigate(`/app/${featured.slug}`)}>
              View Details
            </Button>
            <Button size="lg" variant="outline" className="bg-primary-foreground/10" onClick={() => window.open(api.getFileUrl(featured.apk_file), '_blank')}>
